...
class MapWindow(QMainWindow):
    ...
    def zoom_in(self):
        """放大地圖"""
        self.label.scale_factor *= 1.2  # 每次放大 20%
        self.label.update_image(self.label.pixmap().toImage(), self.label.image_height, self.label.origin, self.label.resolution)

    def zoom_out(self):
        """縮小地圖"""
        self.label.scale_factor *= 0.8  # 每次縮小 20%
        self.label.update_image(self.label.pixmap().toImage(), self.label.image_height, self.label.origin, self.label.resolution)
